# Graphical Debugging (Pre VS2022)
### Extension for Visual Studio

Note: This is a fork of [awulkiew's original repository](https://github.com/awulkiew/graphical-debugging) to support older Versions of VS (before VS2022).
...
You can download this extension from [GitHub](https://github.com/Murkas94/graphical-debugging-pre-vs2022/releases/).
